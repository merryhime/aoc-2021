...
const rooms=Dict('A' => [(2,3), (3,3), (4,3), (5,3)],
                 'B' => [(2,5), (3,5), (4,5), (5,5)],
                 'C' => [(2,7), (3,7), (4,7), (5,7)],
                 'D' => [(2,9), (3,9), (4,9), (5,9)])
...
#    #A#D#C#A#
#    #########
const test=Dict((2,3) => 'B', (3,3) => 'D', (4,3) => 'D', (5,3) => 'A',
                (2,5) => 'C', (3,5) => 'C', (4,5) => 'B', (5,5) => 'D',
                (2,7) => 'B', (3,7) => 'B', (4,7) => 'A', (5,7) => 'C',
                (2,9) => 'D', (3,9) => 'A', (4,9) => 'C', (5,9) => 'A')
...
#    #C#A#D#B#
#    #########
const input=Dict((2,3) => 'D', (3,3) => 'D', (4,3) => 'D', (5,3) => 'C',
                 (2,5) => 'B', (3,5) => 'C', (4,5) => 'B', (5,5) => 'A',
                 (2,7) => 'C', (3,7) => 'B', (4,7) => 'A', (5,7) => 'D',
                 (2,9) => 'A', (3,9) => 'A', (4,9) => 'C', (5,9) => 'B')
...
@assert search(State(test, 0)).score == 44169

function part2()
    display(search(State(input, 0)).score)
end
